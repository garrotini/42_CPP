### [Scale for project CPP Module 06](https://projects.intra.42.fr/projects/cpp-module-06)
...
#### [subject.pdf](https://cdn.intra.42.fr/pdf/pdf/179660/en.subject.pdf)
...
methods ?  
Did the student use the static\_cast to convert values?  
...
This exercise is about using the reinterpret\_cast.
...
Did the student create a class with a private constructor, and static  
methods ?  
The reinterpret\_cast&lt;&gt; should be used twice:

- First from data* to uintptr\_t.
- Then, from uintptr\_t to data*.
...
Does the program work as required?  
Check the code. Did the student use the dynamic\_cast to identify the real  
type?  
